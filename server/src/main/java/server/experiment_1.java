...
public class experiment_1 {
    ...
    private static final String serverModel = "res/model/model_9.zip";
...
//            System.out.println(predicted);
        ...
        //print out to file
        File file = new File("result_9.txt");
    ...
    public static void main(String args[]) throws InterruptedException, IOException {
        ...
        for (int t = 0; t < round; t++) {
            ...
            for (Integer selected_client : selected_clients) {
                int id = (int) selected_client;
