...
public class SmartWatchFileServer {
    ...
    private static void init(int port, int timeout) {
        try {
...
//        while (!checkStopCondition()) {
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        SmartWatchFileServer server = new SmartWatchFileServer();
        SmartWatchFileServer.init(DEFAULT_PORT, DEFAULT_TIMEOUT);
