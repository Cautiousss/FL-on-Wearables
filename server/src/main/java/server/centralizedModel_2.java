...
public class centralizedModel_2 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        final String filenameTrain  = "res/train.csv";
        final String filenameTest  = "res/test.csv";
...
//        System.out.println("ui finish");
        ...
        File locationToSave = new File("res/model/centralized_model_cheat.zip");
